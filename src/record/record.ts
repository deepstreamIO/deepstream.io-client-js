...
import { ConnectionState } from "../constants/constants";
...
export class Record extends EventEmitter {
	...
	public _recordOptions: any; // TODO: Type
	...
	public _$data: any; // TODO: Type
	public version: any; // TODO: Type
	public _eventEmitter: EventEmitter;
	public _queuedMethodCalls: any[]; // TODO: Type
	public _writeCallbacks: { [key: string]: any }; // TODO: Type
	public _mergeStrategy: MergeStrategy; // TODO: Type
	public _resubscribeNotifier: any; // TODO: Type
	public _readAckTimeout: number;
	...
	public set(pathOrData: JSONPath | any, dataOrUndefined?: any): Promise<void> { // TODO: Callback type
		...
		if( resolve ) {
			...
			if( connectionState === ConnectionState.CLOSED || connectionState === ConnectionState.RECONNECTING ) {
	...
	public subscribe(pathOrCallback: JSONPath | Record.SubscribeCallback, callbackOrUndefined?: Record.SubscribeCallback): void {
	...
	public unsubscribe(pathOrCallback: JSONPath | Record.SubscribeCallback, callbackOrUndefined?: Record.SubscribeCallback): void {
		var args = this._normalizeArguments( arguments );
