...
const recordStateTransitions = [
    ...
    { name: RECORD_OFFLINE_ACTIONS.RESUBSCRIBE, from: RECORD_STATE.LOADING_OFFLINE, to: RECORD_STATE.LOADING_OFFLINE, handler: RecordCore.prototype.onResubscribing },
