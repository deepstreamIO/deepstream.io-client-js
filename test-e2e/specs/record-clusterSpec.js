...
describe( 'record cluster', function() {
    ...
    it( 'has updated all records and called their callbacks', function(){
        ...
        expect( recordA.get() ).toEqual({ color: 'red', doors: [ undefined, undefined, 'driverDoor' ] });
        expect( recordB.get() ).toEqual({ color: 'red', doors: [ undefined, undefined, 'driverDoor' ] });
        expect( recordC.get() ).toEqual({ color: 'red', doors: [ undefined, undefined, 'driverDoor' ] });
    });
